...
/* Changed weil NULL Wert wenn bei RG-Erstellung noch keine Adresse vorhanden (20260703 FW)*/
...
(select Z1.zpos_comment from zpos Z1 where Z1.zpos_id=( select max(Z2.zpos_id) from zpos Z2,zpil I2 where Z2.zpos_id=I2.zpil_zpos_id and Z2.zpos_cdt=5 and I2.zpil_zinv_id=zinv_id)) PaymentRefComment,
